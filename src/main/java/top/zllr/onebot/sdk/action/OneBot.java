...
import top.zllr.onebot.sdk.action.misc.ActionList;
import top.zllr.onebot.sdk.action.misc.ActionRaw;
import top.zllr.onebot.sdk.entity.Anonymous;
...
import top.zllr.onebot.sdk.response.contact.FriendInfoResp;
import top.zllr.onebot.sdk.response.contact.LoginInfoResp;
import top.zllr.onebot.sdk.response.contact.StrangerInfoResp;
import top.zllr.onebot.sdk.response.group.GetMsgResp;
import top.zllr.onebot.sdk.response.group.GroupHonorInfoResp;
import top.zllr.onebot.sdk.response.group.GroupInfoResp;
import top.zllr.onebot.sdk.response.group.GroupMemberInfoResp;
import top.zllr.onebot.sdk.response.misc.BooleanResp;
import top.zllr.onebot.sdk.response.misc.GetStatusResp;
...
public interface OneBot {
     ...
     * @return result {@link ActionData} of {@link MsgId}
     */
    ActionData<MsgId> sendMsg(WholeMessageEvent event, List<MsgSegment> msg, boolean autoEscape);
     ...
     * @return result {@link ActionData} of {@link MsgId}
     */
    ActionData<MsgId> sendPrivateMsg(long userId, List<MsgSegment> msg, boolean autoEscape);
     ...
     * @return result {@link ActionData} of {@link MsgId}
     */
    ActionData<MsgId> sendPrivateMsg(long groupId, long userId, List<MsgSegment> msg, boolean autoEscape);
     ...
     * @return result {@link ActionData} of {@link MsgId}
     */
    ActionData<MsgId> sendGroupMsg(long groupId, List<MsgSegment> msg, boolean autoEscape);
