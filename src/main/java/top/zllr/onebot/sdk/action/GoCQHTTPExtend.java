...
import top.zllr.onebot.sdk.entity.GuildMsgId;
import top.zllr.onebot.sdk.entity.MsgId;
import top.zllr.onebot.sdk.event.message.WholeMessageEvent;
import top.zllr.onebot.sdk.response.contact.UnidirectionalFriendListResp;
...
import top.zllr.onebot.sdk.response.group.EssenceMsgResp;
import top.zllr.onebot.sdk.response.group.GroupAtAllRemainResp;
import top.zllr.onebot.sdk.response.group.GroupFilesResp;
import top.zllr.onebot.sdk.response.group.GroupMemberInfoResp;
import top.zllr.onebot.sdk.response.guild.*;
import top.zllr.onebot.sdk.response.misc.*;
